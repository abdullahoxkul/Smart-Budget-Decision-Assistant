...
**Smart Budget & Decision Assistant** is an enterprise-grade **Financial Decision Support System (DSS)** developed by a two-person engineering team, bridging the gap between classical expense tracking, statistical data analytics, machine learning, and rule-based expert systems with a bilingual (EN/TR) interface.

Instead of acting as a passive data-entry tool, the underlying analytical engine actively monitors budget discipline, generates cumulative burn-down forecasts, and functions as a real-time AI financial coach that evaluates spending risks on the fly.
...
* **💡 Real-Time Balance Simulation:** Dynamically calculates and displays the projected post-transaction balance with visual color-coded cues (red/green) *before* the expense is saved.
...
* **Abdullah Özkul** — *Data Science & Statistical Architecture*
...
* **[Teammate's Full Name]** — *Frontend Architecture & Database Design*
